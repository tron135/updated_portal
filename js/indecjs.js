...
! function(t) {
    ...
    function t(t, e) {
        e = e || x;
        var i = P.test(t) ? e.getElementsByClassName(t.slice(1)) : W.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
        return i
    }
    ...
    function n(n, s) {
        ...
        var o = n,
            a = 0,
            r;
        if (A(n)) o = R.test(n) ? x.getElementById(n.slice(1)) : H.test(n) ? e(n) : t(n, s);
    ...
    s.prefixedProp = Y, s.camelCase = z, F.extend({
        css: function(t, e) {
            if (A(t)) return t = Y(t), arguments.length > 1 ? this.each(function(i) {
                return i.style[t] = e
    ...
    return F.extend({
        ...
        offset: function() {
            ...
            return {
                top: t.top + O.pageYOffset - V.clientTop,
                left: t.left + O.pageXOffset - V.clientLeft
            }
        },
...
! function(t) {
    ...
    function r(t, e) {
        var i = o(t),
            n;
        for (n in e) i[n] = H.und(t[n]) ? e[n] : t[n];
        return i
    }
    ...
    function C(t, e) {
        var i = /-?\d*\.?\d+/g,
            n;
        if (n = H.pth(t) ? t.totalLength : t, H.col(n))
            if (H.rgb(n)) {
                var s = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(n);
                n = s ? "rgba(" + s[1] + ",1)" : n
            } else n = H.hex(n) ? l(n) : H.hsl(n) ? h(n) : void 0;
    ...
    function O(t) {
        return H.arr(t) ? W.apply(this, t) : j[t]
    }
    ...
    function S(t) {
        ...
        function s(t) {
            ...
            if (i = Object.keys(n).length)
                for (s = 0; i > s; s++) P || (P = p(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[P] = n[s].join(" ");
    ...
    var I = {
        ...
        j = function() {
            ...
            for (o in i) s.type = o, i[s.type].forEach(function(t) {
                return function(i, s) {
                    n["ease" + t.type + e[s]] = H.fnc(i) ? i : W.apply($jscomp$this, i)
                }
            }(s)), s = {
                type: s.type
            };
    ...
    return S.version = "2.2.0", S.speed = 1, S.running = N, S.remove = function(t) {
        ...
        return e.pause(), e.duration = 0, e.add = function(i) {
            return e.children.forEach(function(t) {
                ...
                var s = n.offset;
                n.autoplay = !1, n.direction = e.direction, n.offset = H.und(s) ? i : g(s, i), e.began = !0, e.completed = !0, e.seek(n.offset), n = S(n), n.began = !0, n.completed = !0, n.duration > i && (e.duration = n.duration), e.children.push(n)
